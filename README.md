#### **DISCLAIMER**: Whether we deal with *blockers* to remove content/functionality or *add-ons* to augment it, there will always be differing opinions. (For example, it is your decision whether you use an ad-blocker or not). I respect your conscience.
...
- [macOS (universal)](https://github.com/erykjj/jwlIntegrator/releases/latest/download/jwlIntegrator_macos.tar.gz) - **UNTESTED** - please report
