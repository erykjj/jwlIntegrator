...
You will need to downgrade to v15.6: [guide 1](https://github.com/erykjj/jwlIntegrator/blob/main/iOS_downgrade.md) or [guide 2](https://github.com/erykjj/jwlIntegrator/blob/main/install-custom-jwpub-guide).
