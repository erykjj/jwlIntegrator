...
> 📌 **NOTE:** Don't worry about entering your Apple Account password directly into Terminal. ipatool communicates with Apple's servers to authenticate your account, and Apple will require two-factor authentication as part of the sign-in process.
...
**Tools → Manage Apps** (see image below)
...
If you had JW Library before, you'll see two entries — your existing JW Library and the newly imported 15.6 version (if you're installing from scratch, you'll just see the one). This confirms the import worked before you touch your original app — if it fails here, your currently installed JW Library is untouched.
...
- You may need to restart JW Library for the imported files to appear
